...
export function LanguageToggle({ current, isCompact = false }: LanguageToggleProps) {
  ...
  return (
    <div
      className="inline-flex items-center rounded-full border border-slate-200/80 bg-slate-100/90 p-0.5 backdrop-blur-xl shadow-xs transition-[padding,gap] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]"
      role="group"
